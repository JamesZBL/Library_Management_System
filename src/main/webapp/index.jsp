...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="h-static/h-ui.admin/skin/default/skin.css" id="skin"/>
...
<header class="navbar-wrapper">
    <div class="navbar navbar-fixed-top">
        <div class="container-fluid cl"><a class="logo navbar-logo f-l mr-10 hidden-xs"
                                           href="/aboutHui.shtml">图书管理系统</a>
            <%--<a class="logo navbar-logo-m f-l mr-10 visible-xs" href="/aboutHui.shtml">H-ui</a>--%>
            <span class="logo navbar-slogan f-l mr-10 hidden-xs">v1.7.6</span>
                ...
                <ul class="cl">
                    <li class="dropDown dropDown_hover"><a href="javascript:;" class="dropDown_A"><i
                        ...
                        <ul class="dropDown-menu menu radius box-shadow">
                            <li><a href="javascript:;" onclick="article_add('添加资讯','')"><i
                                    class="Hui-iconfont">&#xe616;</i> 资讯</a></li>
                            <li><a href="javascript:;" onclick="picture_add('添加资讯','')"><i
                                    class="Hui-iconfont">&#xe613;</i> 图片</a></li>
                            <li><a href="javascript:;" onclick="product_add('添加资讯','')"><i
                ...
                <ul class="cl">
                    ...
                    <li class="dropDown dropDown_hover">
                        ...
                        <ul class="dropDown-menu menu radius box-shadow">
                            ...
                            <li><a href="#">切换账户</a></li>
                            <li><a href="javascript:;" onclick="logoutConfirm();">退出</a></li>
                        </ul>
                    </li>
...
<aside class="Hui-aside">
    <div class="menu_dropdown bk_2">
        ...
        <dl id="menu-picture">
            ...
            <dd>
                <ul>
                    <li><a data-href="book/page" data-title="图书管理" href="javascript:void(0)">图书管理</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-product">
    ...
    <div id="Hui-tabNav" class="Hui-tabNav hidden-xs">
        <div class="Hui-tabNav-wp">
            <ul id="min_title_list" class="acrossTab cl">
                <li class="active">
                    <span title="我的桌面" data-href="welcome.html">欢迎使用</span>
                    <em></em></li>
            </ul>
        </div>
...
<%--dialogs--%>
<div id="modal_logout_confirm" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
     aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content radius">
            <div class="modal-header">
                <h3 class="modal-title">图书管理系统</h3>
