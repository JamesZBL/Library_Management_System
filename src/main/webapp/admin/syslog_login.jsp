			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td background="../images/img/tab_05.gif"><strong><img
							...
							class="STYLE1">登录日志 </span> </strong></td>
										...
										<tr style="padding-left: 30px;" height="40">
											<td style="height: 500px;">
												<div class="easyui-layout"
													...
													<div data-options="region:'north',border:false"
														...
														<form id="searchForm">
															<table>
																<tr>
																	<th>账号:</th>
																	<td><input name="login_name" placeholder="请输入登录账号" /></td>
																	<th>时间:</th>
													...
													<div
														data-options="region:'center',border:true,title:'登录日志列表'">
