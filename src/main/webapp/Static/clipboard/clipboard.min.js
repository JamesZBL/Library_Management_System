	...
	return function e(t, n, i) {
		...
		5 : [ function(e, t, n) {
			function i(e) {
				...
				else if ("INPUT" === e.nodeName || "TEXTAREA" === e.nodeName) e.focus(), e.setSelectionRange(0, e.value.length), t = e.value;else {
		...
		7 : [ function(t, n, i) {
			!function(o, r) {
				...
				else if ("undefined" != typeof i) r(n, t("select"));else {
					var a = {
						exports : {}
					};
		...
		8 : [ function(t, n, i) {
			!function(o, r) {
				...
				else if ("undefined" != typeof i) r(n, t("./clipboard-action"), t("tiny-emitter"), t("good-listener"));else {
					var a = {
						exports : {}
					};
				...
				var s = o(t),
					...
					h = function(e) {
						function t(e, n) {
							r(this, t);var i = a(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this));
