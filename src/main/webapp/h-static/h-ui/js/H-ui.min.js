...
!function ($) {
    $.fn.Huispinner = function (options) {
        var defaults = {value: 1, minValue: 1, maxValue: 999, dis: 1,};
        ...
        this.each(function () {
            ...
            that.append(str);
            var input = that.find(".input-text"), subtract = that.find(".subtract"), add = that.find(".add"),
...
(function ($) {
    ...
    ColorPicker.prototype.addColor = function (color) {
        ...
        var $a = $('<a href="###" class="cp-tile"></a>', {titile: color}).data("color", color).css({
    ...
    ColorPicker.prototype.updateColors = function (colors) {
        var $picker = this.$picker, $menu = this.$menu.empty(), options = this.options, colors = colors || this.colors,
            that = this;
        var bestLineCount = 0;
...
!function ($) {
    $.fn.Huitab = function (options) {
        var defaults = {tabBar: ".tabBar span", tabCon: ".tabCon", className: "current", tabEvent: "click", index: 0,};
        var options = $.extend(defaults, options);
        this.each(function () {
            var that = $(this);
...
!function ($) {
    $.fn.Huitags = function (options) {
        var defaults = {value: "Hui前端框架,H-ui,辉哥", maxlength: 20, number: 5, tagsDefault: ["Html", "CSS", "JS"],};
        var options = $.extend(defaults, options);
        var keyCodes = {Enter: 13, Enter2: 108, Spacebar: 32};
        this.each(function () {
            var that = $(this);
...
!function ($) {
    $.fn.Huitextarealength = function (options) {
        var defaults = {minlength: 0, maxlength: 140, errorClass: "error", exceed: true,};
        var options = $.extend(defaults, options);
        this.each(function () {
            var that = $(this);
            var v = that.val();
...
!function ($) {
    $.fn.Huipreview = function (options) {
        var defaults = {className: "active", bigImgWidth: 300,};
        var options = $.extend(defaults, options);
        this.each(function () {
            var that = $(this);
            var timer;
